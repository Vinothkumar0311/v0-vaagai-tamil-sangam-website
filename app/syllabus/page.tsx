        ...
        <section className="bg-primary py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto">
              வாகை தமிழ்ச்சங்கத்தின் தமிழ் கற்றல் பாடத்திட்டங்கள் அனைத்து வயதினருக்கும் பொருத்தமானவை
            </p>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-cream">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              தமிழ் கற்றலில் ஆர்வமுள்ளவர்கள் எங்கள் பாடத்திட்டங்களில் சேர விண்ணப்பிக்கலாம். 
              அனைத்து வயதினருக்கும் ஏற்ற பாடத்திட்டங்கள் உள்ளன.
            </p>
