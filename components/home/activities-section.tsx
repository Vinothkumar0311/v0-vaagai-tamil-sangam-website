    ...
    <section className="w-full py-12 sm:py-16 md:py-20 lg:py-24 bg-background overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl">
        ...
        <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-muted-foreground max-w-3xl mx-auto text-balance">
        ...
        <Card className="mb-8 sm:mb-10 md:mb-12 bg-muted/50 border-primary/10">
          <CardContent className="p-4 sm:p-6 md:p-8">
            <div className="text-center space-y-2">
              {competitionPoem.lines.map((line, index) => (
                <p key={index} className="text-sm sm:text-base md:text-lg text-foreground/80 italic">
                  {`"${line}`}{index === competitionPoem.lines.length - 1 && '"'}
                </p>
              ))}
              <p className="text-xs sm:text-sm text-muted-foreground pt-2 sm:pt-3">
        ...
        {/* Activity Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          {activities.map((activity) => (
            <Card
              key={activity.id}
              className={cn(
                "overflow-hidden border-0 shadow-lg transition-all hover:shadow-xl hover:-translate-y-1",
            ...
            >
              ...
              <CardContent>
                {activity.quote && (
                  <p className={cn(
                    "text-xs sm:text-sm italic mb-2 sm:mb-3",
